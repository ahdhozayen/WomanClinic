...
class Past_Medical_History(models.Model):
    ...
    pulmonar= models.BooleanField(default=False,blank=True, null=True, verbose_name=_('Pulmonar'))
    ...
    autoimmun_disorder_value = models.CharField(max_length=50, blank=True, null=True, verbose_name=_('Autoimmun Disorder Name'))
    ...
    kidney_disease_value= models.CharField(max_length=255, blank=True, null=True, verbose_name=_('Kidney Disease Name'))
    ...
    hld_value= models.CharField(max_length=20, blank=True, null=True, verbose_name=_('HLD Name'))
    ...
    thyroid_dysfunction_value = models.CharField(max_length=20, choices=thyroid_dysfunction_list, blank=True, null=True, verbose_name=_('THYROID DYSFUNCTION Name'))
    ...
    history_of_blood_transfusion_value = models.CharField(max_length=20, blank=True, null=True, verbose_name=_('History Of Blood Transfusion Name'))
