...
$(function() {
  ...
  var i = function() {
    ...
    n < 768 ? ($("div.navbar-collapse").removeClass("show"), i = 100) : $("div.navbar-collapse").addClass("show");
  ...
  $(window).bind("load resize", i);
  for (var n = window.location, e = $("ul.nav a").filter(function() {
      return this.href == n
    }).addClass("active").parent();;) {
    if (!e.is("li")) break;
    e = e.parent().addClass("in").parent()
  }
  i()
});
